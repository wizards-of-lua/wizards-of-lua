...
public class CopiedWolBlock extends WolBlock {
  private IBlockState blockState;
  private final @Nullable NBTTagCompound nbt;

  public CopiedWolBlock(IBlockState blockState, @Nullable NBTTagCompound nbt) {
  ...
  public CopiedWolBlock(IBlockState blockState, @Nullable TileEntity tileEntity) {
    this.blockState = checkNotNull(blockState, "blockState==null!");
    if (tileEntity != null) {
