 ...
 */
@GenerateLuaClass(name = VirtualEntityApi.NAME)
@GenerateLuaDoc(subtitle = "Blah")
public class VirtualEntityApi<D extends VirtualEntity> extends LuaClassApi<D> {
  public static final String NAME = "VirtualEntity";

  public VirtualEntityApi(DelegatorLuaClass<?, ?> luaClass, D delegate) {
