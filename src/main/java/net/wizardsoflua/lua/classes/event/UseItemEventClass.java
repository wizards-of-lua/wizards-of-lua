...
public class UseItemEventClass
    extends BasicLuaClass<LivingEntityUseItemEvent, UseItemEventClass.Instance<?>> {
  ...
  @Override
  protected Delegator<Instance<?>> toLuaInstance(LivingEntityUseItemEvent javaInstance) {
