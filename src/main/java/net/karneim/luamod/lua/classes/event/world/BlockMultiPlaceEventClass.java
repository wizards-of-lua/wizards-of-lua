...
//
//@LuaModule("BlockMultiPlaceEvent")
//public class BlockMultiPlaceEventClass extends DelegatingLuaClass<BlockMultiPlaceEvent> {
//  public BlockMultiPlaceEventClass(LuaTypesRepo repo) {
//    super(repo);
//  }
//
//  @Override
