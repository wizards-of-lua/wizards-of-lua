...
@LuaModule("PlayerSetSpawnEvent")
public class PlayerSetSpawnEventClass extends DelegatingLuaClass<PlayerSetSpawnEvent> {
  public PlayerSetSpawnEventClass(LuaTypesRepo repo) {
    super(repo);
  }
