...
@LuaModule("NoteBlockChangeEvent")
public class NoteBlockChangeEventClass extends DelegatingLuaClass<NoteBlockChangeEvent> {
  public NoteBlockChangeEventClass(LuaTypesRepo repo) {
    super(repo);
  }
