 ...
 *
 * <p>
 * To instantiate a new {@code ImmutableTable}, use one of the static constructor methods (e.g.,
 * {@link #of(Iterable)}), or a {@link PatchedImmutableTable.Builder} as follows:
 * </p>
 *
 * <pre>
 * ImmutableTable t =
 *     new PatchedImmutableTable.Builder().add("key1", "value1").add("key2", "value2").build();
 * </pre>
 *
 * <p>
 * <b>A word of caution:</b> this class violates the expectation that all Lua tables are mutable,
 * and should therefore be used with care. In order to create a mutable copy of this table, use
 * {@link #newCopy(TableFactory)}.
 * </p>
 */
public class PatchedImmutableTable extends Table {
  ...
  /**
   * Returns an {@code ImmutableTable} based on the contents of the sequence of map entries
   * {@code entries}.
   *
   * <p>
   * For every {@code key}-{@code value} pair in {@code entries}, the behaviour of this method is
   * similar to that of {@link Table#rawset(Object, Object)}:
   * </p>
   * <ul>
   * <li>when {@code value} is <b>nil</b> (i.e., {@code null}), then {@code key} will not have any
   * value associated with it in the resulting table;</li>
   * <li>if {@code key} is <b>nil</b> or <i>NaN</i>, a {@link IllegalArgumentException} is thrown;
   * </li>
   ...
   *
   * <p>
   * Keys may occur multiple times in {@code entries} &mdash; only the last occurrence counts.
   * </p>
   *
   ...
   *         <i>NaN</i> key
   */
  public static PatchedImmutableTable of(Iterable<Map.Entry<Object, Object>> entries) {
   ...
   *
   * <p>
   * For every {@code key}-{@code value} pair in {@code map}, the behaviour of this method is
   * similar to that of {@link Table#rawset(Object, Object)}:
   * </p>
   * <ul>
   * <li>when {@code value} is <b>nil</b> (i.e., {@code null}), then {@code key} will not have any
   ...
   */
  public static PatchedImmutableTable of(Map<Object, Object> map) {
    return of(map.entrySet());
  }

  /**
   * Returns a new table constructed using the supplied {@code tableFactory}, and copies the
  ...
  public boolean equals(Object o) {
    ...
    if (o == null || getClass() != o.getClass())
      return false;
    PatchedImmutableTable that = (PatchedImmutableTable) o;
    if (entries.isEmpty()) {
