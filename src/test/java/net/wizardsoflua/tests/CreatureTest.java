...
public class CreatureTest extends WolTestBase {
  ...
  // /test net.wizardsoflua.tests.CreatureTest test_instanceOf
  @Test
  ...
  // /test net.wizardsoflua.tests.CreatureTest test_ai_is_true
  @Test
  ...
  // /test net.wizardsoflua.tests.CreatureTest test_ai_is_false
  @Test
  ...
  // /test net.wizardsoflua.tests.CreatureTest test_ai_is_writable
  @Test
