...
@Mod(WolTestenv.MODID)
@EventBusSubscriber(bus = Bus.MOD)
public class WolTestenv {
  ...
  public void onServerStarting(FMLServerStartingEvent event) {
    WolServerTestenv serverTestenv = new WolServerTestenv(this, event.getServer());
    MinecraftForge.EVENT_BUS.register(serverTestenv);
    CommandDispatcher<CommandSource> dispatcher = event.getCommandDispatcher();
    new TestCommand(serverTestenv).register(dispatcher);
  }
